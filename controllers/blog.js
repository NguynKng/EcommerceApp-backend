...
const addBlog = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ success: false, message: "Error in add blog." });
  }
};
...
const getBlogs = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ success: false, message: "Error in get blogs." });
  }
};
...
const getBlogById = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ success: false, message: "Error in get blog by id." });
  }
};
...
const updateBlogById = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ success: false, message: "Error in update blog by id." });
  }
};
...
const deleteBlogById = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ success: false, message: "Error in delete blog by id." });
  }
};
